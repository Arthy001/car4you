    ...
    <div className="relative mb-8" id="listings">
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">
          Over {totalCount.toLocaleString()} cars
        </h2>
          ...
          {activeDropdown === "all" && (
            <div className="absolute left-0 mt-3 w-80 sm:w-96 bg-white rounded-3xl shadow-2xl border border-slate-100 p-5 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
              <div className="flex items-center justify-between pb-3 border-b border-slate-100 mb-4">
                <span className="font-bold text-slate-900">All Filters</span>
                <button
              ...
              <div className="mb-4">
                <div className="flex justify-between text-xs font-semibold text-slate-700 mb-2">
                  ...
                  <span className="text-indigo-600 font-bold">${filters.maxPrice} /day</span>
                </div>
                <input
                  type="range"
                  min="40"
              ...
              {/* Car type */}
              <div className="mb-4">
                <span className="block text-xs font-semibold text-slate-700 mb-2">Car Type</span>
              ...
              {/* Fuel Type */}
              <div className="mb-4">
                <span className="block text-xs font-semibold text-slate-700 mb-2">Fuel Type</span>
                <div className="flex flex-wrap gap-1.5">
                  {FUEL_TYPES.map((fuel) => {
        ...
        <div className="relative">
          ...
          >
            ...
            {filters.maxPrice < 600 && (
              <span className="text-xs font-semibold text-indigo-600">(${filters.maxPrice})</span>
            )}
      ...
      {/* Floating Settings Widget on the right edge (as seen in screenshots) */}
